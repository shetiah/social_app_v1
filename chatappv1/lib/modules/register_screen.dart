                            ...
                            children: [
                              ...
                              ConditionalBuilder(
                                ...
                                builder: (context) => defaultButton(
                                  function: () {
                                    // cubit.takeNextData(email:  cubit.emailRegisterController.text, password: cubit
                                    //       .passwordRegisterController.text, name: cubit.nameRegisterController.text,);
                                    if (cubit.formRegisterKey.currentState!
                                        .validate()) {
                                      RegisterCubit.get(context).userRegister(
                                        name: cubit.nameRegisterController.text,
                                        email:
                                            cubit.emailRegisterController.text,
                                        password: cubit
